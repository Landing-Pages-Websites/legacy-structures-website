...
export const metadata: Metadata = createPageMetadata({
  title: "Two-Car Double-Wide Garages | Legacy Structures",
  description:
    "Double-wide garages near Hudson Falls, NY for two vehicles, workshops, and equipment. Explore 24-foot widths, on-site joining, and request a local quote.",
  ...
  return (
    <div>
      ...
      <PageHero
        ...
        backgroundImage={siteAssets.categoryPage.doubleWideGarages.src}
        variant="navy"
      />
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row">
          ...
          <div className="lg:w-[67%]">
            <Image
              src={siteAssets.categoryPage.doubleWideGarages.src}
              alt="Double Wide Garages by Legacy Structures"
              width={siteAssets.categoryPage.doubleWideGarages.width}
              height={siteAssets.categoryPage.doubleWideGarages.height}
